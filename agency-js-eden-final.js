...
(function () {
  ...
  function applyStatusStyling() {
    ...
    for (var i = 0; i < wrappers.length; i++) {
      ...
      // Check if next sibling is a Read status — merge into one line
      var mergedReadText = "";
      ...
      w.style.setProperty("padding-right", "50px", "important");
      ...
      s1.style.setProperty("margin-right", "1px", "important");
      ...
      if (mergedReadText) {
        ...
        s2.style.setProperty("margin-right", "1px", "important");
      ...
      if (!mergedReadText && match.cls === "eden-status-read") {
        s1.style.setProperty("margin-right", "64px", "important");
      }
    }
  }
